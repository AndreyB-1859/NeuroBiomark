...
class AttentionDenseNet121(nn.Module):
    def __init__(self, num_classes=2, attention=SEBlock, reduction=16, pretrained=True, freeze_until="denseblock4"):
        super().__init__()
    ...
    def _freeze_model_features(self, up_to="denseblock4"):
        freeze = True
